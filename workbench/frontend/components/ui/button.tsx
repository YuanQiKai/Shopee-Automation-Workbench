...
const buttonVariants=cva('btn',{variants:{variant:{default:'btn-primary',outline:'btn-outline',ghost:'btn-ghost',destructive:'btn-danger'},size:{default:'',sm:'btn-sm'}},defaultVariants:{variant:'default',size:'default'}});
